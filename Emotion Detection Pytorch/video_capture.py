...
# model_state = torch.load("./models/one_epoch_model.pth", map_location ='cpu')
# model_state = torch.load("./models/emotion_detection_model_state.pth")
model_state = torch.load("./models/30_and_junyi_epoch_model.pth")
# model_state = torch.load("./models/junyi_model.pth")
...
current_moment = current_date + ' - ' + current_time


fourcc = cv2.VideoWriter_fourcc(*'mp4v')
recording_path = current_moment + '.mp4'
